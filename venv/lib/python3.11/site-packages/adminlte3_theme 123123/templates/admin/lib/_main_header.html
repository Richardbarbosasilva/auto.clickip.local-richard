            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                  ...
                  <li class="user-footer">
                    <a href="{% block change_password_url %}{% url 'admin:password_change' %}{% endblock %}" class="btn btn-default btn-flat">{% trans 'Mudar Senha'%}</a>
                    <a href="anything{% logout_url %}{% endblock %}" class="btn btn-default btn-flat float-right">{% trans 'Sair'%}<a>
                  </li>
                </ul>
              </li>
            {% endif %}
