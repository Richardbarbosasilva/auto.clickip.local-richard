...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="/login" class="nav-link">Administrator</a>
        </li>
    </ul>
            ...
            <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-footer">
                                <a href="{% block change_password_url %}{% url 'admin:password_change' %}{% endblock %}" class="btn btn-primary btn-sm">{% trans 'Mudar Senha' %}</a>
                                <a  href="anything{% logout_url %}{% endblock %}" class="btn btn-danger btn-sm">{%trans 'Logoff'%}</a>
                            </div>
